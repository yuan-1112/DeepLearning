...
# 数据集配置文件
data_yaml_path = "E:\\desktop(zhuomian)\\yolov10-main\\datasets\\SeaShips7000\\myshipvoc.yaml"
# 预训练模型
...
if __name__ == '__main__':
 ...
 # 训练模型
 results = model.train(data=data_yaml_path,epochs=30,batch=4,name='train_v16')